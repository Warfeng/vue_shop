      ...
      <el-table :data='rolesList' border>
        ...
        <el-table-column type='expand'>
          <template slot-scope='scope'>
            <el-row :class="['btmbor', 'vcenter', i1 === 0 ? 'topbor' : '']" v-for='(item1, i1) in scope.row.children'
              :key='item1.id'>
              <!--              一级权限 -->
              <el-col :span='5'>
              ...
              <el-col :span='19'>
                <!--  二级权限-->
                <el-row :class="[i2 === 0 ? '' : 'topbor', 'vcenter']" v-for='(item2, i2) in item1.children'
                  :key='item2.id'>
                  <el-col :span='6'>
...
export default {
  ...
  methods: {
    ...
    // 通过递归的方式、获取角色下所有的三级权限id，并保存到defKeys中
